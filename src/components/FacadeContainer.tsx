...
const segments = [
  {
    ...
    hasWindowPediments: true,
    windowFrameClass: 'bg-ochre-600/30',
    groundFloorVariant: 'grand' as const,
  },
  {
    title: 'WARMTH',
    label: 'Human',
    ...
    hasAnchors: false,
    groundFloorVariant: 'simple' as const,
  },
  {
    title: 'SYSTEMS',
    label: 'Scalable',
    ...
    hasAnchors: true,
    groundFloorVariant: 'arched' as const,
  },
  {
    title: 'LONGEVITY',
    label: 'Enduring',
    ...
    heightClass: 'h-[75%]',
    roofShape: 'baroque' as const,
    windowFrameClass: 'bg-secondary/25',
    groundFloorVariant: 'simple' as const,
  },
];
