...
const HeroSection = () => {
  ...
  return (
    <section className="col-span-12 lg:col-span-5 flex flex-col justify-center mt-10 lg:mt-0">
      <h1 className="animate-reveal font-display font-extrabold text-[clamp(3rem,8vw,6rem)] leading-[0.9] mb-6 text-primary tracking-tighter" dangerouslySetInnerHTML={{ __html: t('home.headline') }} />
