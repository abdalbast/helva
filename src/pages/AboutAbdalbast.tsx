    ...
    <AnimatedPage>
      <>
        <Helmet>
          ...
          <meta
            name="description"
            content="About Abdalbast Khdhir at Helva Group. Shipping production AI features with a focus on reliability, evaluation, and end to end delivery."
          />
            ...
            {JSON.stringify({
              ...
              itemListElement: [
                { "@type": "ListItem", position: 1, name: "Home", item: "https://helva.group" },
                {
                  "@type": "ListItem",
                  position: 2,
                  name: "About Abdalbast Khdhir",
                  item: "https://helva.group/about-abdalbast-khdhir",
                },
              ],
            })}
          </script>
        ...
        <main id="main-content" className="min-h-screen grid grid-cols-12 p-5 lg:p-10 gap-5">
          ...
          <section className="col-span-12 lg:col-span-8 mb-16">
            <span className="font-mono text-[0.65rem] uppercase tracking-[0.2em] text-muted-foreground mb-4 block">
              Founder
            </span>
            ...
            <p className="text-lg text-muted-foreground leading-relaxed max-w-2xl mb-4">
              I build and ship AI powered product features end to end, from prototype to production. My focus is getting
              real systems working reliably in the hands of users, with clear evaluation, measurable outcomes, and
              maintainable engineering.
            </p>
            <p className="text-lg text-muted-foreground leading-relaxed max-w-2xl mb-8">
              This page is the short version of who I am and the work I do at Helva Group. If you want the fastest
              overview, use the links below, or scroll for selected work and working style.
            </p>
            <div className="flex flex-wrap gap-3">
              <a
                href="https://www.linkedin.com/in/abdalbast/"
                target="_blank"
                rel="noopener noreferrer"
                className="font-mono text-[0.7rem] uppercase tracking-[0.15em] border border-border/50 px-5 py-2.5 text-muted-foreground hover:text-foreground hover:border-foreground/30 transition-colors duration-300"
              >
                LinkedIn
              </a>
              <a
                href="https://github.com/abdalbast"
                target="_blank"
                rel="noopener noreferrer"
                className="font-mono text-[0.7rem] uppercase tracking-[0.15em] border border-border/50 px-5 py-2.5 text-muted-foreground hover:text-foreground hover:border-foreground/30 transition-colors duration-300"
              >
          ...
          <section className="col-span-12 mb-16">
            <span className="font-mono text-[0.65rem] uppercase tracking-[0.2em] text-muted-foreground mb-6 block">
              More
            </span>
            <div className="flex flex-wrap gap-3">
              <Link
                to="/abdalbast-khdhir-portfolio"
                className="font-mono text-[0.7rem] uppercase tracking-[0.15em] border border-border/50 px-5 py-2.5 text-muted-foreground hover:text-foreground hover:border-foreground/30 transition-colors duration-300"
              >
                Portfolio
              </Link>
              <Link
                to="/abdalbast-khdhir-projects"
                className="font-mono text-[0.7rem] uppercase tracking-[0.15em] border border-border/50 px-5 py-2.5 text-muted-foreground hover:text-foreground hover:border-foreground/30 transition-colors duration-300"
              >
                Projects
              </Link>
          ...
          <section id="contact" className="col-span-12 lg:col-span-8 mb-16">
            ...
            <p className="text-muted-foreground mb-2">
              If you want to collaborate, hire, or talk about shipping AI into real products, reach out.
            </p>
            ...
            {status === "sent" ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-4 max-w-md">
                <div>
                  <label
                    htmlFor="name"
                    className="block font-mono text-[0.65rem] uppercase tracking-[0.2em] text-muted-foreground mb-2"
                  >
                    Name
                  </label>
                  <input
                    ...
                    className="w-full border border-border bg-background px-3 py-2 text-sm text-foreground focus:outline-none focus:ring-2 focus:ring-ring"
                  />
                ...
                {status === "error" && (
                  <p className="text-destructive text-xs">Something went wrong. Please try again.</p>
                )}
              </form>
            )}
          </section>
