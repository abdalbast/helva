        ...
        <section className="col-span-12 mb-10 space-y-4">
          <div>
            ...
            <div className="flex flex-wrap gap-2">
              {CATEGORIES.map((c) => (
                <FilterPill key={c} label={c} active={activeCategory === c} onClick={() => setActiveCategory(activeCategory === c ? null : c)} />
              ))}
            </div>
          </div>
          <div>
            ...
            <div className="flex flex-wrap gap-2">
              {STATUSES.map((s) => (
                <FilterPill key={s} label={s} active={activeStatus === s} onClick={() => setActiveStatus(activeStatus === s ? null : s)} />
              ))}
            </div>
          </div>
        </section>
